...
async def user_proceed_payment(update: Update, context: ContextTypes.DEFAULT_TYPE, is_callback=True):
    ...
    if is_callback:
        try:
            ...
            pass
    await context.bot.send_photo(chat_id=user_id, photo=qr_url, caption=caption, reply_markup=markup, parse_mode="Markdown")
    ...
    if data.startswith("buy_"):
        ...
        try:
            ...
            if license_key or data_resp.get("status") == "success":
                ...
                err_msg = data_resp.get("msg") or data_resp.get("message") or "Provider Server Maintenance"
